  ...
  document.querySelectorAll('.filter-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if(f === 'all'){
        ...
        document.getElementById('fc').textContent='Showing all 13 projects + 3 BIM tools';
      } else {
        ...
        const counts = {paloalto:'1 project', monterey:'11 projects', orangecounty:'1 project', bim:'3 BIM tools'};
